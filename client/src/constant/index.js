export const surprisePrompts = [
    ...
    'A mystical portal leading to another dimension, surrounded by eerie energy and guarded by powerful beings',
    'A massive castle built into the side of a mountain, surrounded by a moat and defended by brave knights',
    'A futuristic society where robots and humans live and work together, creating a utopia of peace and prosperity',
    'A picturesque village nestled in the rolling hills, surrounded by lush farmland and dotted with charming cottages',
    'A dark and dangerous dungeon, filled with traps and inhabited by fearsome beasts, where brave adventurers seek treasure and glory',
    'A time machine that travels through the ages, taking its passengers on incredible adventures through history',
    'A peaceful and serene Japanese garden, dotted with k'
  ];
